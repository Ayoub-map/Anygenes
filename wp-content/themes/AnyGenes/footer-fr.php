...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KSCJB9G"
				...
				<footer>
					      	...
					      	<div class="top-footer">
								...
								<form action="http://localhost/anygenes/register.php" method="POST" >
									...
									if(empty($_SESSION['nom'])){
										?>
										<input class="foSrm-control form-control-sm" type="text" name="email" value="" size="40" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" placeholder="Your Email" required/>
										<?php } else {?>
